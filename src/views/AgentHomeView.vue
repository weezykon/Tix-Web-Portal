  ...
  <div class="app">
    ...
    <div class="sidebar" :class="{ 'sidebar-open': isMobileMenuOpen }">
      ...
      <div class="user-profile">
        <img class="user-avatar" src="https://via.placeholder.com/32x32/8B5CF6/FFFFFF?text=SM" alt="Profile" />
        <div class="user-info">
...
const recentActivity = ref([
  {
    ...
    time: '30 min ago',
    avatar: 'https://via.placeholder.com/32x32/10B981/FFFFFF?text=D'
  },
  {
    id: 2,
    user: 'Jenny',
    action: 'responded',
    subject: 'Requires refund',
    time: '40 min ago',
    avatar: 'https://via.placeholder.com/32x32/8B5CF6/FFFFFF?text=J'
  },
  {
    id: 3,
    user: 'Robert',
    action: 'is assigned',
    subject: 'Problems with settings',
    time: '1h ago',
    avatar: 'https://via.placeholder.com/32x32/F59E0B/FFFFFF?text=R'
  },
  {
    id: 4,
    user: 'Jules',
    action: 'mentioned you',
    subject: 'Cannot access the system',
    time: '1h ago',
    avatar: 'https://via.placeholder.com/32x32/EF4444/FFFFFF?text=J'
  },
  {
    id: 5,
    user: 'Sophie',
    action: 'responded',
    subject: 'Lost order is still missing',
    time: '2h ago',
    avatar: 'https://via.placeholder.com/32x32/06B6D4/FFFFFF?text=S'
  },
  {
    id: 6,
    user: 'Jenny',
    action: 'responded',
    subject: 'Requires e-copy invoice',
    time: '4h ago',
    avatar: 'https://via.placeholder.com/32x32/8B5CF6/FFFFFF?text=J'
  },
  {
    ...
    user: 'Jules',
    action: 'mentioned',
    subject: "Jenny Can't update user profile",
    time: '5h ago',
    avatar: 'https://via.placeholder.com/32x32/EF4444/FFFFFF?text=J'
  }
])
